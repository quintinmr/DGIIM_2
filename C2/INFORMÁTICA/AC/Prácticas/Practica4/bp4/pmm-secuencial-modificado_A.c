...
int main(int argc, char** argv){
    ...
    // Calcular m3 = m1 * m2
    // Para reducir el tiempo de ejecución, podemos desenrollar
    // los bucles en la variable j; 4 operaciones más por bucle.
    ...
    {
    	printf("Tiempo: %11.9f \t Tamaño: %u \n m1[0][0]:%8.6f \t m1[N-1][N-1]: %8.6f\n m2[0][0]:%8.6f \t m2[N-1][N-1]: %8.6f\nm3[0][0]: %8.6f \t m3[N-1][N-1]: %8.6f \n", ncgt, N, m1[0][0], m1[N-1][N-1], m2[0][0], m2[N-1][N-1], m3[0][0], m3[N-1][N-1]);    
    }
    return(0);
}
