...
// Se crea un proceso hijo que emppieza a ejecutarse junto al padre y una vez que llega a execl, deja de ejecutar las siguientes líneas de código para empezar a ejecutar el programa
// pasado como argumento a la función execl. A continuación el padre espera a que el hijo termine y obtiene el estado con el que ha finalizado el mismo.
