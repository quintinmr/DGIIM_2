...
indice_buscado = buscaIgualIndice(T, n);
...
// Salida
if (indice_buscado == 0 && T[0] != 0) cout << "Elemento no encontrado" << endl;
else cout << "Indice: " << indice_buscado << " elemento:"<< T[indice_buscado]<< endl;
